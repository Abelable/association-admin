...
import { ArticleBannersSearchParams } from "types/article";

export interface SearchPanelProps {
  params: Partial<ArticleBannersSearchParams>;
  setParams: (params: Partial<ArticleBannersSearchParams>) => void;
}
...
export const SearchPanel = ({ params, setParams }: SearchPanelProps) => {
  const defaultParams = {
    is_show: "",
    title: "",
  } as Partial<ArticleBannersSearchParams>;

  const [temporaryParams, setTemporaryParams] =
    useState<Partial<ArticleBannersSearchParams>>(params);
